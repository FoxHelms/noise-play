...
'''https://gist.github.com/eevee/26f547457522755cb1fb8739d0ea89a1#file-perlin-py'''
# Licensed under ISC
...
class PerlinNoiseFactory(object):
    ...
    def get_plain_noise(self, *point):
        ...
        while len(dots) > 1:
            ...
            # Dimension value minus dimension minimum
            s = smoothstep(point[dim] - grid_coords[dim][0])
            # print(f'Smoothstep: {s}')

            next_dots = []
            while dots:
                next_dots.append(lerp(s, dots.pop(0), dots.pop(0)))
                # print(f'Next_dots: {next_dots}')
